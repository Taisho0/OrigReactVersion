            ...
            {activeTab === 'sales' && (
              <div className="rounded-2xl sm:rounded-4xl border border-white/10 bg-slate-950/80 p-3 sm:p-4 md:p-6">
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  <div className="rounded-2xl sm:rounded-4xl border border-white/10 bg-slate-950/85 p-3 sm:p-4 lg:p-5 shadow-2xl shadow-black/20 backdrop-blur-sm">
                  ...
                  <div className="grid gap-3 sm:gap-4 md:grid-cols-2">
                    <div className="rounded-2xl sm:rounded-4xl border border-white/10 bg-slate-950/85 p-3 sm:p-4 shadow-2xl shadow-black/20 backdrop-blur-sm flex flex-col min-h-0">
                      ...
                      {salesAnalytics.topProducts.length === 0 ? (
                        ...
                        <ChartContainer className="h-48 sm:h-64 lg:h-80 rounded-2xl bg-slate-950/80 p-2 sm:p-4" config={{ revenue: { color: '#f59e0b' } }}>
                          <PieChart>
                            <Pie
